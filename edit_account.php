        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?= $_settings->userdata('id') ?>">
                <div class="form-group">
                    ...
                    <input type="text" name="firstname" class="form-control form" value="<?= $_settings->userdata('firstname') ?>" required>
                </div>
                <div class="form-group">
                    <label for="lastname" class="control-label">Lastname</label>
                    <input type="text" name="lastname" class="form-control form" value="<?= $_settings->userdata('lastname') ?>" required>
                </div>
                <div class="form-group">
                    <label for="username" class="control-label">Username</label>
                    <input type="text" name="username" class="form-control form" value="<?= $_settings->userdata('username') ?>" required>
                </div>
                <div class="form-group">
