...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=pagckages/manage" class="btn btn-flat btn-info"><span class="fas fa-plus"></span>  Buat Baru</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?= $row['question'] ?></td>
							<td><span class="truncate"><?= $row['response_message'] ?></span></td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=responses/manage&id=<?= $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
