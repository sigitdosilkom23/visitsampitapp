	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nama Pendek Sistem</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Tentang</label>
	             <textarea name="about_us" id="" cols="30" rows="2" class="form-control summernote"><?=  is_file(base_app.'about.html') ? file_get_contents(base_app.'about.html') : "" ?></textarea>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Privacy Policy</label>
	             <textarea name="privacy_policy" id="" cols="30" rows="2" class="form-control summernote"><?=  is_file(base_app.'privacy_policy.html') ? file_get_contents(base_app.'privacy_policy.html') : "" ?></textarea>
			</div>
			...
			<div class="form-group d-flex justify-content-center">
				<img src="<?= validate_image($_settings->info('cover')) ?>" alt="" id="cimg2" class="img-fluid img-thumbnail">
			</div>
			</form>
		</div>
