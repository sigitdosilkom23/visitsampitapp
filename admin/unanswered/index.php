				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?= $row['question'] ?></td>
							<td class="text-center"><?= number_format($row['no_asks']) ?></td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=responses/manage&q=<?= $row['question'] ?>"><span class="fa fa-edit text-primary"></span> Create Response</a>
