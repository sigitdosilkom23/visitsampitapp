...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Daftar Saran Pengunjung</h3>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['email'] ?></td>
                        <td><p class="truncate-1 m-0"><?= $row['subject'] ?></p></td>
                        ...
                        <td align="center">
                                ...
                                <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?= $row['id'] ?>"><span class="fa fa-file text-primary"></span> View</a>
