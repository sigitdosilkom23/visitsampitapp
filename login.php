...
<div class="container-fluid">
        ...
        <div class="col-lg-5 border-right">
            ...
            <form action="" id="login-form">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn btn-primary btn-flat">Masuk</button>
                </div>
            </form>
        </div>
        <div class="col-lg-7">
  ...
  <body>
    <form action="?" method="POST">
      <div class="g-recaptcha" data-sitekey="6Lfz03UhAAAAALO7rVnkaEDjZxxzJ5MyoQMc9l8b"></div>
      <br/>
      <input type="submit" value="Submit">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn btn-primary btn-flat">Daftar</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
      ...
      var onloadCallback = function() {
        grecaptcha.render('html_element', {
          'sitekey' : '6Lfz03UhAAAAALO7rVnkaEDjZxxzJ5MyoQMc9l8b'
        });
      };
    ...
    $(function(){
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Selamat !!! Akun berhasil dibuat",'success')
                        setTimeout(function(){
                            location.reload()
                        },2000)
        ...
        $('#login-form').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Berhasil Masuk",'success')
                        setTimeout(function(){
                            location.reload()
                        },2000)
